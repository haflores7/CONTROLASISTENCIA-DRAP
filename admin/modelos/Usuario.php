...
//Función para verificar el acceso al sistema
	public function verificar($login, $clave) {
		$sql = "SELECT u.idusuario, u.nombre, u.apellidos, u.login, u.email, u.imagen, u.codigo_persona, 
				u.iddepartamento, u.idtipousuario, u.estado, tu.nombre as tipousuario 
				FROM usuarios u 
